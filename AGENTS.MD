...
Be liberal in verification, conservative in speculation. Use all available tools to validate: code search, static analysis, local runs, sandboxed execution, and web research with sources.
