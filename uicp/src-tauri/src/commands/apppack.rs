...
use crate::codegen::apppack::{AppPackInstall, AppPackManifest};
use crate::AppState;

#[tauri::command]
pub async fn apppack_validate(dir: String) -> Result<AppPackManifest, String> {
    crate::codegen::apppack::apppack_validate(dir).await
}
...
pub async fn apppack_install(
    ...
    crate::codegen::apppack::apppack_install(state, dir).await
}

#[tauri::command]
pub async fn apppack_entry_html(installed_id: String) -> Result<String, String> {
    crate::codegen::apppack::apppack_entry_html(installed_id).await
}
