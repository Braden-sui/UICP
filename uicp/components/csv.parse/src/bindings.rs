            ...
            impl ::core::fmt::Debug for Input {
                fn fmt(
                    ...
                    f.debug_struct("Input")
                        ...
                        .field("has-header", &self.has_header)
                        .finish()
                }
            }
    ...
    pub mod uicp {
        pub mod task_csv_parse {
            ...
            pub mod task {
                ...
                pub type Input = super::super::super::super::uicp::task_csv_parse::types::Input;
                pub type Output = super::super::super::super::uicp::task_csv_parse::types::Output;
                #[repr(u8)]
                ...
                pub unsafe fn _export_run_cabi<T: Guest>(
                    ...
                    let result2 = T::run(
                        ...
                        super::super::super::super::uicp::task_csv_parse::types::Input {
                            source: _rt::string_lift(bytes1),
                            has_header: _rt::bool_lift(arg4 as u8),
                        },
                    );
                ...
                #[doc(hidden)]
                macro_rules! __export_uicp_task_csv_parse_task_1_2_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "uicp:task-csv-parse/task@1.2.0#run")] unsafe extern "C" fn
                        ...
                        #[unsafe (export_name =
                        "cabi_post_uicp:task-csv-parse/task@1.2.0#run")] unsafe extern
                        "C" fn _post_return_run(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_run::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_uicp_task_csv_parse_task_1_2_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_entry_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::uicp::task_csv_parse::task::__export_uicp_task_csv_parse_task_1_2_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::uicp::task_csv_parse::task);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:uicp:task-csv-parse@1.2.0:entry:encoded world"
)]
#[doc(hidden)]
...
\x03\0\x17uicp:host/control@1.0.0\x05\x07\x01B\x05\x01r\x02\x06sources\x0ahas-he\
ader\x7f\x04\0\x05input\x03\0\0\x01ps\x01p\x02\x04\0\x06output\x03\0\x03\x03\0\x1f\
uicp:task-csv-parse/types@1.2.0\x05\x08\x02\x03\0\x05\x05input\x02\x03\0\x05\x06\
output\x01B\x09\x02\x03\x02\x01\x09\x04\0\x05input\x03\0\0\x02\x03\x02\x01\x0a\x04\
\0\x06output\x03\0\x02\x01m\x03\x09cancelled\x0dinvalid-input\x09csv-error\x04\0\
\x05error\x03\0\x04\x01j\x01\x03\x01\x05\x01@\x02\x03jobs\x05input\x01\0\x06\x04\
\0\x03run\x01\x07\x04\0\x1euicp:task-csv-parse/task@1.2.0\x05\x0b\x04\0\x1fuicp:\
task-csv-parse/entry@1.2.0\x04\0\x0b\x0b\x01\0\x05entry\x03\0\0\0G\x09producers\x01\
