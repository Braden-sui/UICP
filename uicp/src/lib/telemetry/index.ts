...
const EVENT_DEFAULTS: Partial<Record<TelemetryEventName, EventDefaults>> = {
  ...
  llm_stream_start: { span: 'api', kind: 'span_start' },
  llm_stream_complete: { span: 'api', kind: 'span_finish', status: 'ok' },
  llm_stream_error: { span: 'api', kind: 'instant', status: 'error' },
  provider_error_mapped: { span: 'api', kind: 'instant', status: 'error' },
  ...
  apply_handshake_start: { span: 'queue', kind: 'instant' },
  apply_handshake_ack: { span: 'queue', kind: 'instant' },
  router_provider_selected: { span: 'api', kind: 'instant' },
  auth_preflight_result: { span: 'api', kind: 'instant' },
  collector_source: { span: 'collector', kind: 'instant' },
  linter_reject: { span: 'batch', kind: 'instant' },
  ...
  'resilience.retry_attempt': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.circuit_opened': { span: 'resilience', kind: 'instant', status: 'error' },
  'resilience.circuit_closed': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.circuit_half_open': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.failure_injected': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.failure_stopped': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.provider_health_check': { span: 'resilience', kind: 'instant', status: 'ok' },
  'resilience.metrics_summary': { span: 'resilience', kind: 'instant', status: 'ok' },
};
